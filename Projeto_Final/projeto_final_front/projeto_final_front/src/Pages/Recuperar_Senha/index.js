        ...
        <div className='container text-align'>
            ...
            <div className="row">
                <div className='col-6 mx-auto'>
                    <label htmlFor="inputNome" className="form-label mt-4 text-align">Nome</label>
            ...
            <div className='col-6 mx-auto'>
                    <label htmlFor="inputEmail" className="form-label mt-4 text-align">Email</label>
